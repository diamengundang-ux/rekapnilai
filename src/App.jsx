  ...
  return (
    <div className="flex h-screen bg-slate-100 font-sans text-slate-900">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 shadow-xl z-10">
        <div className="p-6 flex items-center gap-3 border-b border-slate-100"><div className="bg-blue-600 text-white p-2 rounded-lg"><GraduationCap size={24} /></div><div><h1 className="font-bold text-lg text-slate-800 tracking-tight">NILAIKU</h1><p className="text-xs text-slate-500">Sistem Rekap PJOK</p></div></div>
        ...
        <div className="p-4 border-t border-slate-100">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-4 text-white"><p className="text-xs opacity-70 mb-1">Versi Aplikasi</p><p className="font-bold text-sm">v2.0 (SaaS Edition)</p><p className="text-xs mt-2 opacity-50">© 2025 Ardika Yudha Developer</p></div>
        </div>
      </aside>
      <main className="flex-1 overflow-y-auto relative">
        <div className="md:hidden bg-white p-4 shadow-sm flex justify-between items-center sticky top-0 z-20"><div className="flex items-center gap-2 font-bold text-slate-800"><div className="bg-blue-600 text-white p-1.5 rounded-lg"><GraduationCap size={18} /></div>NILAIKU</div><button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 text-slate-600">{isMobileMenuOpen ? <X /> : <Menu />}</button></div>
